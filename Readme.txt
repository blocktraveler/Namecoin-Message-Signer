...
====================================================================================
  ...
  * Configure RPC credentials
    ...
    You can also just copy the configuration file predefined in the 'config' folder.
...
====================================================================================
  ...
  - Automatic wallet type detection (descriptor, HD, legacy).
  ...
  * Outbound Compatibility: Signatures generated by this script can also be verified by the native RPC `verifymessage` of Namecoin Core v0.18 up to v0.27.1.
...
====================================================================================
  ...
  IMPORTANT: Handle all private keys and signatures with caution! Mishandling them 
  may result in the loss of funds or assets. Use this tool responsibly.
